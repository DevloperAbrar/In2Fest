module.exports = (sequelize, DataTypes) => {
  const Slot = sequelize.define("Slot", {
    ...
    pricing_type: {
      type: DataTypes.ENUM("time_slot", "full_day", "hourly"),
      defaultValue: "time_slot",
      allowNull: false
    },
    service_type:  { type: DataTypes.STRING, allowNull: true },
    total_units:   { type: DataTypes.INTEGER, defaultValue: 1, allowNull: false },
    ...
    days_of_operation: { type: DataTypes.JSONB, defaultValue: ["mon","tue","wed","thu","fri","sat","sun"] },
